...
class BilingualDataset(Dataset):
    """
    Dataset class for bilingual translation.
    """
    ...
    def __init__(self, ds, tokenizer_src, tokenizer_tgt, src_lang, tgt_lang, seq_len):
        ...
        Args:
            ds (list): List of translation pairs.
    ...
    def __getitem__(self, idx):
        ...
        Returns:
            dict: Dictionary containing the encoder input, decoder input, encoder mask, decoder mask, label,
